                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        ?>
											...
											<td><?php echo $cls->class;?></td>
												...
												<table border="1" width="100%">
														<tr> 
														<?php 	$queryString = "SELECT SUM(`extraQuantity`) AS `extraQuantity`  FROM `enter_stock1` WHERE `hsn_sac`='".$cls->id."'  AND  `company_name`='".$record->company_name."';";
		    $oldQuantity = $this->db->query($queryString)->result();
		
		    $queryString = "SELECT SUM(`product_quantity`) AS `total` FROM `product_sale` WHERE `hsn_sac`='".$cls->id."'  AND `company_name`='".$record->company_name."';";
